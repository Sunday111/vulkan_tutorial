...
void DeviceSurfaceInfo::Populate(VkPhysicalDevice device,
                                 VkSurfaceKHR surface) {
  VkWrap(vkGetPhysicalDeviceSurfaceCapabilitiesKHR)(device, surface,
                                                    &capabilities);
...
VkSurfaceFormatKHR DeviceSurfaceInfo::ChooseSurfaceFormat(
    const VkSurfaceFormatKHR& preferred) const noexcept {
  size_t best_index = 0;
  int best_score = -1;
